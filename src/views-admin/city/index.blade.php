...
@section('pagetitle','المدن وتكلفة الشحن')
@section('content')
<div class="container-fluid">
    <a href="{{ route(LaraShop::adminName().'.city.create') }}" class="btn btn-outline-success">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">المدن وتكلفة الشحن</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">{{ @$city->shipping_cost }}</td>
                                    <td class="fit">
                                        <form action="{{ route(LaraShop::adminName().'.city.destroy', $city->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            @permitTo('UpdateLarashopCity')
                                            <a href="{{ route(LaraShop::adminName().'.city.edit',[$city->id]) }}" class="text-info">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <span class="mx-1"></span>
                                            @endpermitTo
                                            @permitTo('DeleteLarashopCity')
