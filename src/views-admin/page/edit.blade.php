...
<span class="breadcrumb-item active">تعديل صفحة</span>
@endsection


@section('pagetitle','تعديل صفحة')
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route(LaraShop::adminName().'.page.update', $page) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="editor form-control" id="body" name="body">{{ old('body', $page->body) }}</textarea>
                            @error('body')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
